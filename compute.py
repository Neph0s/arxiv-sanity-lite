...
if __name__ == '__main__':
    ...
    v = TfidfVectorizer(input='content',
                        ...
                        ngram_range=(1, 1), max_features=args.num,
    ...
    def make_corpus(training: bool):
        ...
        for p in keys:
            ...
            # Filter out stop words from summary using nltk
            import nltk
            ...
            tokens = word_tokenize(d['summary'])

            from remove_words import academic_stopwords

            filtered_summary = ' '.join([word for word in tokens if word.lower() not in stop_words.union(academic_stopwords)])
            d['summary'] = filtered_summary
